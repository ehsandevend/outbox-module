from outbox.outbox.repository import OutboxRepo
from outbox.outbox.services.publisher.http import (
    SingleHTTPPublisher,
    BulkHTTPPublisher,
)
...
class SingleLogOutboxService(IOutboxService):
    def __init__(self):
        self.repo = OutboxRepo()
        self.publisher = SingleHTTPPublisher()
